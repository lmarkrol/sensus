...
<div class="page-content">
    <div class="page-header">
        <h1 style="color:#585858">
          ...
          <a href='?module=form_sub&form=add&id=<?php echo "$kode_project";?>'>
...
// jika alert = 1
// tampilkan pesan "data Anggota baru berhasil disimpan"
elseif ($_GET['alert'] == 1) { ?>
...
// jika alert = 2
// tampilkan pesan Sukses "data Anggota berhasil diubah"
elseif ($_GET['alert'] == 2) { ?>
    <div class="alert alert-success">
        <button type="button" class="close" data-dismiss="alert">
            <i class="ace-icon fa fa-times"></i>
...
// jika alert = 3
// tampilkan pesan Sukses "data Anggota berhasil dihapus"
elseif ($_GET['alert'] == 3) { ?>
    <div class="alert alert-success">
        <button type="button" class="close" data-dismiss="alert">
            <i class="ace-icon fa fa-times"></i>
        ...
        <div class="col-xs-12">
            ...
            $kode_project = $_GET['id'];
                            ...
                            $query = mysqli_query($mysqli, "SELECT
                                                         a.*,b.DOC from sub a, kl b where  a.NO_KK=b.NO_KK
                                                         AND a.NO_KK='$kode_project'
                                                    ")
                                    ...
                                    <td width="100"><?php echo $data['NO_KK']; ?></td>
                                     <td width="100"><?php echo $data['NIK']; ?></td>
                                      <td width="100"><?php echo $data['NAMA']; ?></td>
                                        ...
                                        <img id="myImg" style="padding:1px" class="profile-picture" src="../sensus/upload/kk/<?php echo $data['DOC']; ?>" height="150">
                                    </td>
