...
<div class="page-content">
    <div class="page-header">
        <h1 style="color:#585858">
            <i class="ace-icon fa fa-list"></i> Data Kependudukan / Kepala Keluarga
            <a href="?module=form_kk&form=add">
...
// jika alert = 1
// tampilkan pesan "data Kepala Keluarga baru berhasil disimpan"
elseif ($_GET['alert'] == 1) { ?>
    <div class="alert alert-success">
        ...
        data Kepala Keluarga baru berhasil disimpan.
        <br>
    </div>
<?php
} 
// jika alert = 2
// tampilkan pesan Sukses "data Kepala Keluarga berhasil diubah"
elseif ($_GET['alert'] == 2) { ?>
    <div class="alert alert-success">
        <button type="button" class="close" data-dismiss="alert">
            <i class="ace-icon fa fa-times"></i>
        ...
        <strong><i class="ace-icon fa fa-check-circle"></i> Sukses! </strong><br>
        data Kepala Keluarga berhasil diubah.
        <br>
    </div>
<?php
}
// jika alert = 3
// tampilkan pesan Sukses "data Kepala Keluarga berhasil dihapus"
elseif ($_GET['alert'] == 3) { ?>
    <div class="alert alert-success">
        <button type="button" class="close" data-dismiss="alert">
            <i class="ace-icon fa fa-times"></i>
...
")
                            ...
                            <tr>
                                    ...
                                    <td width="100"><?php echo $data['NO_KK']; ?></td>
                                     <td width="100"><?php echo $data['NIK']; ?></td>
                                      ...
                                      <td width="100"><?php echo $data['JK']; ?></td>
                        ...
                        <div>
                           <a data-toggle='tooltip' data-placement='top' title='Detail' style='margin-right:5px' class='btn btn-primary btn-sm' href="?module=view_sub&id=<?php echo $data['NO_KK']; ?>">
                                                <i style='color:#fff' class='glyphicon glyphicon-th-list'></i>

                                            </a>

                                           <a data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px' class='btn btn-primary btn-sm' href="?module=form_kk&form=edit&id=<?php echo $data['NO_KK']; ?>">
